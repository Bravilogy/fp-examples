...
export default () => (
    <section className='content'>
        ...
        <p>
            ...
            be cool to have a nice repo for real life examples of using functional approach to very
            <strong>common</strong> or <strong>not-so-common</strong> problems.
        </p>
        <p>
            I will be using <a href='http://ramdajs.com/' target='_blank'>ramda.js</a> library in most cases and
            a few nice functional data types from <a href='https://github.com/ramda/ramda-fantasy' target='_blank'>Ramda
            Fantasy</a> in other cases.
        </p>
        <p>
